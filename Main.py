	...
	async with aiohttp.get(url) as r:
		if r.status == 200:
			try:
				...
				embed.add_field(name="Nickname", value="{}".format(user), inline=True)
				embed.add_field(name="Rank", value="{}".format(rank), inline=True)
				embed.add_field(name="Premium Account", value="{}".format(premium), inline=True)
				embed.add_field(name="Experience", value="{:,}".format(experience), inline=True)
				...
				embed.add_field(name="Gear Score", value="{}".format(gearscore), inline=True)
