...
async def info(ctx):
	...
	embed.set_thumbnail(url=https://cdn.discordapp.com/avatars/{0.id}/{0.avatar}.png?size=1024".format(bot.user.avatar_url))
	embed.set_footer(text=" | {}".format(bot.user.name), icon_url=https://cdn.discordapp.com/avatars/{0.id}/{0.avatar}.png?size=1024".format(bot.user.avatar_url))
	await bot.say(embed=embed)
	channel = bot.get_channel('525109045221261312')
