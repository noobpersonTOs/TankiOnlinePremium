...
cont = ["**|** You found a common item: **3,500 Crystals**",
	...
	"**|** You found an exotic item: **Railgun <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Thunder <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Shaft <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Wasp <:XT:614526948726669351>**",
	"**|** You found an exotic item: **1,000,000 crystals**",
	"**|** You found an exotic item: **Firebird <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Isida <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Hammer <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Hornet <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Viking <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Titan <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Hunter <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Ricochet <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Twins <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Freeze <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Striker <:XT:614526948726669351>**",
	"**|** You found an exotic item: **Mammoth <:XT:614526948726669351>**"]
...
async def invites(ctx):
    ...
    link = await bot.create_invite(destination = ctx.message.channel, max_age = 1)
...
async def info(ctx):
	...
	embed.add_field(name="Support server", value=f"[Link](https://discord.gg/cj2eSAs)")
	embed.add_field(name="Donate", value=f"[Link](https://www.paypal.me/Dark0ufaYT)")
...
async def vote(ctx):
	embed = discord.Embed(description=" ", color=0xFFFF)
	embed.add_field(name="Upvote me", value=f"[Upvote me here](https://discordbots.org/bot/409253229491126285/vote)")
	await bot.say(embed=embed)
...
async def _promote(ctx, user: discord.Member = None, *, name = None):
	...
	await bot.add_roles(user, role)
	await bot.delete_message(ctx.message)
	text = await bot.say(f"User {user.name} has been promoted to {role.name} role".format(role.name))
	await asyncio.sleep(5)
	await bot.delete_message(text)
...
async def help1(ctx):
	...
	embed.add_field(name="say", value="d!say [Text] - Make the bot say something - don't abuse this.", inline=True)
	embed.add_field(name="d!info", value="get info about support server, and more.", inline=True)
	embed.add_field(name="d!serverinfo", value="get info about the server", inline=True)
...
async def moderations(ctx):
	...
	embed.add_field(name="ban", value="`d!ban [member] [reason]`")
	embed.add_field(name="warn", value="`d!warn [member] [reason]`")
...
@bot.command(pass_context=True)
async def maths(ctx):
	embed = discord.Embed(title="math", description="d!math add [amount] [amount]", color=0xFFFF)
	embed.add_field(name="math", value="d!math subtract [amount] [amount]")
	embed.add_field(name="math", value="d!math multiply [amount] [amount]")
